...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2015 at 11:43 AM
...
(2, 'Pilot', 'Flying high above the sky no lie', 1);
...
(8, 'Bachelor of Science Telecommunication', 'A course where you study the intricacies of Telecommunication', 1),
(9, 'Bachelor of Business Science in Actuarial Science', 'Risk analy, Risk MItigation', 1),
(10, 'Bachelor of Science in Hospitality Management', 'A course that does not only expose candidates to the confines of the kitchen and the living room but also to the hotel industry operations and management.', 1);
...
(1, 'Football', '22 men chasing a ball and goal', 1),
...
(2, 'INTP', 'Innovative inventors with an unquenchable thirst for knowledge.', 1),
(3, 'ENTJ', 'Bold, imaginative and strong-willed leaders, always finding a way or making one.', 1),
(4, 'ENTP', 'Smart and curious thinkers who cannot\r\nresist an intellectual challenge.', 1),
(5, 'INFJ', 'Quiet and mystical, yet very inspiring and tireless idealists.', 1),
(6, 'INFP', 'Poetic, kind and altruistic people, always eager to help a good cause.', 1),
(7, 'ENFJ', 'Charismatic and inspiring leaders, able\r\nto mesmerize their listeners.', 1),
(8, 'ENFP', 'Enthusiastic, creative and sociable free spirits, who can always find a reason to smile.', 1),
(9, 'ISTJ', 'Practical and factminded individuals,\r\nwhose reliability cannot be doubted.', 1),
(10, 'ISFJ', 'Very dedicated and warm protectors, always ready to defend their loved ones.', 1),
(11, 'ESTJ', 'Excellent administrators, unsurpassed at managing things or people.', 1),
(12, 'ESFJ', 'Extraordinarily caring, social and popular people, always eager to help.', 1),
(13, 'ISTP', 'Bold and practical experimenters, masters of all kinds of tools.', 1),
(14, 'ISFP', 'Flexible and charming artists, always ready to explore and experience something new.', 1),
(15, 'ESTP', 'Smart, energetic and very perceptive people, who truly enjoy living on\r\nthe edge.', 1),
(16, 'ESFP', 'Spontaneous, energetic and enthusiastic\r\nentertainers - life is never boring around them.', 1);
...
INSERT INTO `subjects` (`subject_id`, `subject_name`, `isactive`) VALUES
(1, 'Mathematics', 1),
(2, 'Physics', 1),
(3, 'Biology', 1),
(4, 'Geography', 1);
...
CREATE TABLE IF NOT EXISTS `subject_career` (
  `subject_career_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `grade_id` int(11) NOT NULL,
  `career_id` int(11) NOT NULL,
  `isactive` int(11) NOT NULL DEFAULT '1'
...
(14, 'left', 'account/interests.php', 'Interests', 11, '', 'fa fa-puzzle-piece', 0),
...
(34, 'left', 'account/match.php', 'match', 12, '', 'fa fa-check-square-o', 0);
...
(34, 'account/interests.php', 0),
(35, 'account/match.php', 0),
(36, 'account/viewuniversities.php', 0),
(37, 'account/viewuni.php', 0);
...
(1, 'admin', 'Unisearch Admin', '$2y$10$I/eaDpaW.8xCur6fn9BlAeorQlZphkjwJ12lkDiToOXNrU7FSJtim', 'admin@unisearch.com', '51d1702ae61338a19fa1f8cb731c463d', 1420136350, 0, 1420136350, 1, 'Master Account', 1420136350, 1424620009, 1, 2),
...
(6, 'sheldon', 'Sheldon Rotich', '$2y$10$OflMj6L9.TXAJYgOYtovOu3duUOvDQ4XZTgWXaR50BHxGMHqTchx.', 'skrotich@gmail.com', 'f56af9e4f446344228a8897efd05c733', 1423129399, 0, 1423129399, 1, 'New Member', 1423129399, 1423129413, 1, 1),
(7, 'kay', 'Kay', '$2y$10$tyOR0v656ZrE4xl0DF9Gc.Ny8TqyDeNe2awRQFVQhcBLGCBfwGpaa', 'kayima@aol.com', '45d2097ecddeb301d2ba404e0da5290c', 1424097801, 0, 1424097801, 1, 'New Member', 1424097801, 1424097810, 1, 1);
...
CREATE TABLE IF NOT EXISTS `universities` (
  ...
  `uni_website` varchar(100) NOT NULL,
  `crawl_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`uni_id`),
  UNIQUE KEY `uni_website` (`uni_website`),
  KEY `uni_website_2` (`uni_website`)
...
INSERT INTO `universities` (`uni_id`, `uni_name`, `uni_address`, `uni_website`, `crawl_date`) VALUES
(737, 'Strathmore University', 'https://www.google.co.ke/maps/place/Strathmore+University', 'www.strathmore.edu', '2015-02-15 18:05:05'),
(738, 'Kenyatta University', 'https://www.google.co.ke/maps/place/Kenyatta+University', 'www.ku.ac.ke', '2015-02-15 18:05:05'),
(739, 'kcauniversity.com registered at Homepage', 'https://www.google.co.ke/maps/place/kcauniversity.com+registered+at+HomepageUniverse+%3A%3A+Names%2C+Tools%2C+Hosting', 'www.kcauniversity.com', '2015-02-15 18:05:09'),
(742, 'Kenya Methodist University', 'https://www.google.co.ke/maps/place/Kenya+Methodist+University', 'www.kemu.ac.ke', '2015-02-15 18:05:17'),
(745, 'UNIVERSITY OF NAIROBI', 'https://www.google.co.ke/maps/place/UNIVERSITY+OF+NAIROBI', 'www.uonbi.ac.ke', '2015-02-15 18:05:24'),
(752, 'Harvard University', 'https://www.google.co.ke/maps/place/Harvard+University', 'www.harvard.edu', '2015-02-15 18:05:30'),
(759, 'The Catholic University of Eastern Afric', 'https://www.google.co.ke/maps/place/The+Catholic+University+of+Eastern+Africa', 'www.cuea.edu', '2015-02-15 18:05:38'),
(761, 'Pioneer International  University', 'https://www.google.co.ke/maps/place/Pioneer+International++University', 'www.piu.ac.ke', '2015-02-15 18:05:39'),
(763, 'Maseno University', 'https://www.google.co.ke/maps/place/Maseno+University', 'maseno.ac.ke', '2015-02-15 18:05:39'),
(769, 'Zetech University', 'https://www.google.co.ke/maps/place/Zetech+University', 'www.zetech.ac.ke', '2015-02-15 18:05:45'),
(968, 'Multimedia University of Kenya', 'https://www.google.co.ke/maps/place/Multimedia+University+of+Kenya', 'mmu.ac.ke', '2015-02-19 19:19:43'),
(986, 'Masinde Muliro University of Science and', 'https://www.google.co.ke/maps/place/Masinde+Muliro+University+of+Science+and+Technology', 'www.mmust.ac.ke', '2015-02-19 19:20:01');
...
INSERT INTO `user_interests` (`user_interest_id`, `reg_no`, `interest_id`, `isactive`) VALUES
(1, 4, 1, 1),
(2, 4, 2, 1),
(3, 4, 1, 1),
(4, 4, 2, 1),
...
INSERT INTO `user_personality` (`user_personality_id`, `reg_no`, `personality_id`, `isactive`) VALUES
(1, 4, 16, 1),
(2, 7, 2, 1),
(3, 7, 6, 1);
...
INSERT INTO `user_subject` (`user_subject_id`, `reg_no`, `subject_id`, `grade_id`, `isactive`) VALUES
(1, 4, 1, 2, 1),
(2, 4, 2, 2, 1),
(3, 5, 2, 10, 1),
(4, 5, 3, 10, 1);
